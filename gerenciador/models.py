...
class Trabalho(models.Model):
    ...
    aluno = models.ForeignKey(Usuario, limit_choices_to={'perfil': 'Aluno'}, related_name='Aluno',blank=True, null=True)
    professor = models.ForeignKey(Usuario,limit_choices_to={'perfil': 'Professor'}, related_name='Professor',blank=True, null=True)
