...
class Trabalho(models.Model):
    ...
    professor = models.ForeignKey(Usuario,limit_choices_to={'perfil': 'Professor'}, related_name='Professor')
    aluno = models.ForeignKey(Usuario, limit_choices_to={'perfil': 'Aluno'}, related_name='Aluno')
